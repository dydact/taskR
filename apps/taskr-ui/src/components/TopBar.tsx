...
import type { DensityMode, ViewMode } from '../types/shell';
...
export function TopBar({ viewMode, viewOptions, onViewModeChange, onToggleRightPanel, density, onCycleDensity }: TopBarProps) {
